...
<div class="instructor <?php echo $department; ?>">
  ...
  <?php else: ?>
    ...
    <p class="text-center"><a id="remote-content-menu" rel="<?php the_ID(); ?>" data-url="<?php bloginfo('url'); ?>" data-href="<?php the_permalink(); ?>" href="#remote-content-menu">Read More...</a></p>
  <?php endif; ?>
</div>
