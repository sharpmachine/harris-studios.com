...
?>
			...
			<input class="btn_event_form_submit ui-button ui-button-big ui-priority-primary ui-state-default ui-state-hover ui-state-focus ui-corner-all btn btn-lg btn-success" type="submit" name="confirm" id="confirm" value="<?php _e('Next', 'event_espresso'); ?>" />
		    </p>
		
		
		<?php if ($display_questions != '') { ?>
		
		<div  id="additional-conf-info" class="additional-conf-info event-display-boxes hidden">
			...
			<p class="espresso_confirm_registration hidden">
